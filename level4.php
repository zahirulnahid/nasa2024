...
<head>
  ...
  <title>Orrery Level 4 - Earth and the Moon</title>
  <style>
...
<body>
  <div id="info-panel">
    <h1>Earth and the Moon</h1>
    <p>Click on Earth or the Moon to learn more about them!</p>
  </div>
  <button id="next-button" style="display: none;">Proceed to Level 5</button>
  ...
  <script>
    ...
    // Animation loop (make Earth orbit the Sun and Moon orbit the Earth)
    let earthAngle = 0;
    let moonAngle = 0;
